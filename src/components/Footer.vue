    ...
    <footer>
        <section class="contain-footer">
            ...
            <div class="text-footer">
                <address class="h3-bis">Marthwaite, Sedbergh Cumbria<br/>+00 44 123 4567</address>
                <p class="h3-bis">OPEN TIMES<br/>MON - FRI: 09:00 AM - 10:00 PM <br/>SAT - SUN: 09:00 AM - 11:30 PM</p>
            </div>
        </section>
    </footer>
</template>
